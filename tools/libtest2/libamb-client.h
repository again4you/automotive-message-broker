...
typedef void (*AMB_SIGNAL_CALLBACK)(const gchar *objname, GVariant *data);

int amb_register_signal_handler(gchar *objname, AMB_SIGNAL_CALLBACK c);
int amb_unregister_signal_handler(gchar *objname);
